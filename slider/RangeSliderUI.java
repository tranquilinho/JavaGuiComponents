...
/**
 * UI delegate for the RangeSlider component.  It paints two markers (thumbs),
...
class RangeSliderUI extends BasicSliderUI {
    ...
    private Color selectedRangeColor = Color.GRAY;
    // default: RED / PINK
    private Color upperThumbBorder = Color.DARK_GRAY, upperThumbFill = Color.LIGHT_GRAY;
    // default: BLUE / CYAN
    private Color lowerThumbBorder = Color.DARK_GRAY, lowerThumbFill = Color.LIGHT_GRAY;
    ...
    private void paintLowerThumb(Graphics g) {
        ...
        Shape thumbShape = createLowerThumbShape(w - 1, h - 1);
    ...
    private void paintUpperThumb(Graphics g) {
        ...
        // Create default thumb shape.
        Shape thumbShape = createUpperThumbShape(w - 1, h - 1);
    ...
    private Shape createUpperThumbShape(int width, int height) {
        Path2D triangle = new Path2D.Double();
